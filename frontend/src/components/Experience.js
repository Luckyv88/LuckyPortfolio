...
const [experiences, setExperiences] = useState([]);
 ...
 useEffect(() => {
// FIX: Change hardcoded localhost URL to a relative path
...
{experiences.map(exp => (
 ...
 {exp.certificateUrl && (
 {/* NOTE: certificateUrl paths will work if they are absolute 
                      or relative to the public root (e.g., /assets/cert.pdf). */}
